...
<body>
  ...
  <table style="width: 100%" class="border">
    ...
    <tr style="height: 30px">
      ...
      <td class="border" style="width: 40%; padding-left: 12px; padding-right: 12px;">{{$item->instansi}} @if($item->region_name != "LAIN-LAIN")
        {{$item->region_name}}
        @endif </td>
      {{-- <td class="border" style="width: 20%; padding-left: 12px; padding-right: 12px;">{{ substr($item->scanned_at, 11, 10)}}</td> --}}
      <td class="border center" style="width: 20%; height: 75px;"><img src="{{url('storage/signature/'.$item->signature)}}" height="75px" class="center"></td>
    </tr>
    @endforeach
  </table>
